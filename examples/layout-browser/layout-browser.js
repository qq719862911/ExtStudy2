...
var userGridPanel = Ext.create('Ext.grid.Panel', {
    title: '用户管理',
    iconCls:'user',
    store:Ext.data.StoreManager.lookup('myStore'),//使用store
    ...
    columns: [
        ...
        { header: '真实姓名', dataIndex: 'realname', flex: 1 },
    ...
    bbar:{ xtype: 'pagingtoolbar',displayInfo:true,store:Ext.data.StoreManager.lookup('myStore')},//分页条
});
